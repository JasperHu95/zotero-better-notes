...
editor-toolbar-markdownMode = Markdown mode
editor-toolbar-settings-enterMarkdown = Edit as Markdown
editor-toolbar-settings-exitMarkdown = Back to Rich Text
markdownMode-loadError = Better Notes: Failed to open note in Markdown mode
markdownMode-saveError = Better Notes: Failed to save Markdown changes to the note
editor-toolbar-md-heading = Heading
editor-toolbar-md-paragraph = Normal text
editor-toolbar-md-bold = Bold
editor-toolbar-md-italic = Italic
editor-toolbar-md-strikethrough = Strikethrough
editor-toolbar-md-code = Inline code
editor-toolbar-md-link = Link
editor-toolbar-md-bulletList = Bulleted list
editor-toolbar-md-orderedList = Numbered list
editor-toolbar-md-blockquote = Blockquote
editor-toolbar-md-citation = Insert Citation
editor-toolbar-md-underline = Underline
editor-toolbar-md-subscript = Subscript
editor-toolbar-md-superscript = Superscript
editor-toolbar-md-textColor = Text color
editor-toolbar-md-highlightColor = Highlight text
editor-toolbar-md-clearFormat = Clear formatting
editor-toolbar-md-removeColor = Remove color
editor-toolbar-md-search = Find and replace
...
libraryGraph-title = Note Relation Graph
libraryGraph-allLibraries = All Libraries
libraryGraph-showUnlinked = Show unlinked notes
libraryGraph-searchPlaceholder = Search notes…
libraryGraph-rescan = Rescan
libraryGraph-rescan-tooltip = Rebuild the note link index for all notes
