...
editor-toolbar-markdownMode = Режим Markdown
editor-toolbar-settings-enterMarkdown = Редактировать как Markdown
editor-toolbar-settings-exitMarkdown = Вернуться к форматированному тексту
markdownMode-loadError = Better Notes: не удалось открыть заметку в режиме Markdown
markdownMode-saveError = Better Notes: не удалось сохранить изменения Markdown в заметку
editor-toolbar-md-heading = Заголовок
editor-toolbar-md-paragraph = Обычный текст
editor-toolbar-md-bold = Полужирный
editor-toolbar-md-italic = Курсив
editor-toolbar-md-strikethrough = Зачёркнутый
editor-toolbar-md-code = Встроенный код
editor-toolbar-md-link = Ссылка
editor-toolbar-md-bulletList = Маркированный список
editor-toolbar-md-orderedList = Нумерованный список
editor-toolbar-md-blockquote = Цитата
editor-toolbar-md-citation = Вставить цитирование
editor-toolbar-md-underline = Подчёркнутый
editor-toolbar-md-subscript = Нижний индекс
editor-toolbar-md-superscript = Верхний индекс
editor-toolbar-md-textColor = Цвет текста
editor-toolbar-md-highlightColor = Выделение текста
editor-toolbar-md-clearFormat = Очистить форматирование
editor-toolbar-md-removeColor = Убрать цвет
editor-toolbar-md-search = Найти и заменить
