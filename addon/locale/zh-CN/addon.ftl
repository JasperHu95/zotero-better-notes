...
editor-toolbar-markdownMode = Markdown 模式
editor-toolbar-settings-enterMarkdown = 以 Markdown 编辑
editor-toolbar-settings-exitMarkdown = 返回富文本编辑
markdownMode-loadError = Better Notes: 无法以 Markdown 模式打开笔记
markdownMode-saveError = Better Notes: Markdown 更改保存到笔记失败
editor-toolbar-md-heading = 标题
editor-toolbar-md-paragraph = 正文
editor-toolbar-md-bold = 粗体
editor-toolbar-md-italic = 斜体
editor-toolbar-md-strikethrough = 删除线
editor-toolbar-md-code = 行内代码
editor-toolbar-md-link = 链接
editor-toolbar-md-bulletList = 无序列表
editor-toolbar-md-orderedList = 有序列表
editor-toolbar-md-blockquote = 引用
editor-toolbar-md-citation = 插入引注
editor-toolbar-md-underline = 下划线
editor-toolbar-md-subscript = 下标
editor-toolbar-md-superscript = 上标
editor-toolbar-md-textColor = 文字颜色
editor-toolbar-md-highlightColor = 高亮文本
editor-toolbar-md-clearFormat = 清除格式
editor-toolbar-md-removeColor = 移除颜色
editor-toolbar-md-search = 查找和替换
