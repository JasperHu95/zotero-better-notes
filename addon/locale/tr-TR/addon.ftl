...
editor-toolbar-markdownMode = Markdown modu
editor-toolbar-settings-enterMarkdown = Markdown Olarak Düzenle
editor-toolbar-settings-exitMarkdown = Zengin Metne Dön
markdownMode-loadError = Better Notes: Not, Markdown modunda açılamadı
markdownMode-saveError = Better Notes: Markdown değişiklikleri nota kaydedilemedi
editor-toolbar-md-heading = Başlık
editor-toolbar-md-paragraph = Normal metin
editor-toolbar-md-bold = Kalın
editor-toolbar-md-italic = İtalik
editor-toolbar-md-strikethrough = Üstü çizili
editor-toolbar-md-code = Satır içi kod
editor-toolbar-md-link = Bağlantı
editor-toolbar-md-bulletList = Madde işaretli liste
editor-toolbar-md-orderedList = Numaralı liste
editor-toolbar-md-blockquote = Alıntı
editor-toolbar-md-citation = Atıf ekle
editor-toolbar-md-underline = Altı çizili
editor-toolbar-md-subscript = Alt simge
editor-toolbar-md-superscript = Üst simge
editor-toolbar-md-textColor = Metin rengi
editor-toolbar-md-highlightColor = Metni vurgula
editor-toolbar-md-clearFormat = Biçimlendirmeyi temizle
editor-toolbar-md-removeColor = Rengi kaldır
editor-toolbar-md-search = Bul ve değiştir
